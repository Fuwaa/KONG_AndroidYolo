...
public class Yolov5TFLiteDetector {
    ...
    private final int[] OUTPUT_SIZE = new int[]{1, 25200, 14};
    ...
    private final String MODEL_YOLOV5S = "exp42-best-fp16.tflite";
//    private final String MODEL_YOLOV5S = "yolov5s-dynamic.tflite";
    private final String MODEL_YOLOV5N =  "exp42-best-fp16.tflite";
    private final String MODEL_YOLOV5M = "exp42-best-fp16.tflite";
    private final String MODEL_YOLOV5S_INT8 = "exp42-best-fp16.tflite";
    private final String LABEL_FILE = "coco_labelexp42.txt";
    ...
    public void setModelFile(String modelFile){
        switch (modelFile) {
            ...
            case "yolov5s+SimAM":
                ...
                break;
            case "yolov5s+SEAttention":
                IS_INT8 = false;
                MODEL_FILE = MODEL_YOLOV5M;
                break;
            case "yolov5s+ShuffleAttention":
                IS_INT8 = true;
